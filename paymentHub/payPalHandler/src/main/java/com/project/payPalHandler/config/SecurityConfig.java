...
public class SecurityConfig {
	...
	private static final String KEYSTOREFILEPATH = "src/main/resources/paypal_handler_keystore.jks";
	private static final String TRUSTSTOREFILEPATH = "src/main/resources/paypal_handler_truststore.jks";
