...
public class SecurityConfig {
	...
	private static final String KEYSTOREFILEPATH = "src/main/resources/kps_paypal_handler_keystore.jks";
	private static final String TRUSTSTOREFILEPATH = "src/main/resources/kps_paypal_handler_truststore.jks";
	...
	public DiscoveryClientOptionalArgs discoveryClientOptionalArgs() throws NoSuchAlgorithmException {
		...
		builder.withClientName("payPalHandler");
