package com.project.cardPaymentHandler;
...
@EnableScheduling
public class CardPaymentHandlerApplication {

	public static void main(String[] args) {
		initAttributes();
		SpringApplication.run(CardPaymentHandlerApplication.class, args);
	}
