...
public class ClientIdGenerator implements  IdentifierGenerator {
	...
	Random r = new Random();
  private Logger log = LoggerFactory.getLogger(ClientIdGenerator.class);
  Session session;
          ...
          for (int i = 0; i < 3; i++)
			    {
			        ...
			        if ( session.get(NewClientRequest.class, a) == null)
			        {
		    ...
		    for (long i = 1000000000; i < 9999999999l; i++)
			    {
			        ...
			        if ( session.get(NewClientRequest.class, i) == null)
			        {
