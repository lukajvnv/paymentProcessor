...
public class SecurityConfig {
	...
	private static final String KEYSTOREFILEPATH = "src/main/resources/kp_zuul_keystore.jks";
	private static final String TRUSTSTOREFILEPATH = "src/main/resources/kp_zuul_truststore.jks";
