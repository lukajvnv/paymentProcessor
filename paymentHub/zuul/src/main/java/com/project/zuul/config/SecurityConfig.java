...
public class SecurityConfig {
	...
	private static final String KEYSTOREFILEPATH = "src/main/resources/zuul_keystore.jks";
	private static final String TRUSTSTOREFILEPATH = "src/main/resources/zuul_truststore.jks";
