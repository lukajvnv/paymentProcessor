...
public class SecurityConfig {
	...
	private static final String KEYSTOREFILEPATH = "src/main/resources/card_service_keystore.jks";
	private static final String TRUSTSTOREFILEPATH = "src/main/resources/card_service_truststore.jks";
