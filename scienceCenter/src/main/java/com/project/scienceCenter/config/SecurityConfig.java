...
public class SecurityConfig {
	...
	private static final String KEYSTOREFILEPATH = "src/main/resources/naucna_centrala_keystore.jks";
	private static final String TRUSTSTOREFILEPATH = "src/main/resources/naucna_centrala_truststore.jks";
